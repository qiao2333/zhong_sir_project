 ...
 * @Date: 2019-04-26 10:38:12
 * @LastEditTime: 2019-05-08 16:59:48
 -->
...
export default {
  ...
  created() {
    this.postChangeTeacherState();
  },
  methods: {
    postChangeTeacherState(){
      this.axios.post("https://www.easy-mock.com/mock/5cc7ec55c87cb117f3e4ba26/school/changeTeacherState").then(res=>{
        if(res.data.code === 0){
